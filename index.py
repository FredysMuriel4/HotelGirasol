...
tk.Button(root, text="Revisar Reservas", font=font_answers, bg="#eccc68").place(x=20, y=200)
tk.Label(root, image=rImg, bg="#eccc68").place(x=202, y=202, height=35)
dImg = tk.PhotoImage(file="img/remove.png")
tk.Button(root, text="Eliminar Reservas", font=font_answers, bg="#eccc68").place(x=20, y=250)
tk.Label(root, image=dImg, bg="#eccc68").place(x=204, y=252, height=35)
sImg = tk.PhotoImage(file="img/stock.png")
tk.Button(root, text="Registro Extendido", font=font_answers, bg="#eccc68").place(x=20, y=300)
tk.Label(root, image=sImg, bg="#eccc68").place(x=204, y=302, height=35)
fImg = tk.PhotoImage(file="img/invoice.png")
tk.Button(root, text="Facturación", font=font_answers, bg="#eccc68").place(x=20, y=350, width=200)
